                ...
                $.ajax({
                    ...
                    success:function(respuesta){
                        ...
                        if(respuesta == 1){
                            ...
                            swal("Error al eliminar categoría",
                            "Esta categoría contiene archivos, por seguridad no se puede eliminar","error");
                        }
                    }
                });              
            }
    ...
    if($('#categoriaU').val() == "") {
        ...
        $.ajax({
            ...
            success:function(respuesta) {
                ...
                if(respuesta == 1){
                    $('#tablaCategorias').load("categorias/tablaCategoria.php");                    
                    swal("Actualizado correctamente!!","Se ha modificado con exito la categoría","success");
