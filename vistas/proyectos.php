...
<div class="modal fade" id="modalAgregaProyecto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="" id="frmProyectos" autocomplete="off" method="POST" onsubmit="return agregarProyecto()">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            <label for="fechaInicio"><b class="text-danger mr-1">*</b>Fecha de inicio de la
                                residencia:</label>
                            <input type="text" class="form-control readonly" name="fechaInicio" id="fechaInicio"
                                required>
                        </div>
                        <div class="form-group col-md-5">
                            <label for="fechaTermino"><b class="text-danger mr-1">*</b>Fecha de término de la
                                residencia:</label>
                            <input type="text" class="form-control readonly" name="fechaTermino" id="fechaTermino"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="responsable"><b class="text-danger mr-1">*</b>Responsable del proyecto (Asesor
                            externo):</label>
...
<div class="modal fade" id="modalActualizarProyecto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmActualizarProyecto" method="POST" onsubmit="return actualizaProyecto()">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            <label for="fechaInicioU"><b class="text-danger mr-1">*</b>Fecha de inicio de la
                                residencia:</label>
                            <input type="text" class="form-control readonly" name="fechaInicioU" id="fechaInicioU"
                                required>
                        </div>
                        <div class="form-group col-md-5">
                            <label for="fechaTerminoU"><b class="text-danger mr-1">*</b>Fecha de término de la
                                residencia:</label>
                    ...
                    <div class="form-group">
                        <label for="responsableU"><b class="text-danger mr-1">*</b>Responsable del proyecto (Asesor
                            externo):</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="caracteristicasU" id="caracteristicasU"
                            rows="2" placeholder="Ingrese las características del proyecto" required></textarea>
                    </div>
                    <div class="form-group">
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == 1) {
                ...
                swal("Proyecto guardado con éxito!!", "El proyecto se ha guardado satisfactoriamente",
                    "success");
            } else {
...
function actualizaProyecto() {
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == 1) {
                $('#tablaProyectos').load("proyectos/tablaProyectos.php");
                swal("Proyecto actualizado con éxito!!", "El proyecto se actualizo correctamente",
                    "success");
            } else {
